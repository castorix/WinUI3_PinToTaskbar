...
namespace GlobalStructures
{
    ...
    public struct PROPERTYKEY
    {
        ...
        public static readonly PROPERTYKEY PKEY_ItemPathDisplay = new PROPERTYKEY(new Guid("E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD"), 7);
        public static readonly PROPERTYKEY PKEY_ItemUrl = new PROPERTYKEY(new Guid("49691C90-7E17-101A-A91C-08002B2ECDA9"), 9);
        public static readonly PROPERTYKEY PKEY_ItemType = new PROPERTYKEY(new Guid("28636AA6-953D-11D2-B5D6-00C04FD918D0"), 11);
        public static readonly PROPERTYKEY PKEY_SourcePackageFamilyName = new PROPERTYKEY(new Guid("FFAE9DB7-1C8D-43FF-818C-84403AA3732D"), 100);
        public static readonly PROPERTYKEY PKEY_AppUserModel_SettingsCommand = new PROPERTYKEY(new Guid("9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3"), 38);
    }  
